...
export const DiacriticsMap = {
  A: 'AÁĂẮẶẰẲẴǍÂẤẬẦẨẪÄẠÀẢĀĄÅǺÃÆǼ',
  B: 'BḄƁʚɞ',
  C: 'CĆČÇĈĊƆʗ',
  D: 'DĎḒḌƊḎǲǅĐÐǱǄ',
  E: 'EÉĔĚÊẾỆỀỂỄËĖẸÈẺĒĘẼƐƏ',
  F: 'FƑ',
  G: 'GǴĞǦĢĜĠḠʛ',
  H: 'HḪĤḤĦ',
  I: 'IÍĬǏÎÏİỊÌỈĪĮĨĲ',
  ...
  M: 'MḾṀṂ',
  N: 'NŃŇŅṊṄṆǸƝṈǋÑǊ',
  O: 'OÓŎǑÔỐỘỒỔỖÖỌŐÒỎƠỚỢỜỞỠŌƟǪØǾÕŒɶ',
  P: 'PÞ',
  Q: 'Q',
  R: 'RŔŘŖṘṚṜṞʁ',
  S: 'SŚŠŞŜȘṠṢẞ',
  T: 'TŤŢṰȚṬṮŦÞÐ',
  U: 'UÚŬǓÛÜǗǙǛǕỤŰÙỦƯỨỰỪỬỮŪŲŮŨ',
  V: 'V',
  W: 'WẂŴẄẀʬ',
  X: 'X',
  Y: 'YÝŶŸẎỴỲƳỶȲỸ',
...
export const RightsStatements = {
  ...
  '//rightsstatements.org/page/CNE/1.0': 'Copyright Not Evaluated',
